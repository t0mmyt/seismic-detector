...
class SaxDetectTest(unittest.TestCase):
    def setUp(self):
        ...
        self.sax_str_1 = (
            ...
            'ddddddddddddddddddddddddddddddddddddddddacgagdbabbgcgagebgab'
            'gfagddbcbgfgacecfgabgadagaebggeggaadgaagadgfaadggbafggabaefg'
            'abgeabgaafgefgbdbbbagggfeaecaadgggffbbbdccdgeddeaacdffecccbd'
            'fdefcbcbbegfdcccddeedbceeefddceeddeefdecbddddeeddcddeccdeecc'
            'ddeddeeddccbdddccdcdddefdccdcdeedddcdedededdeeedccdddeedddcc'
            'ccddddddccddccddddddcddcddddeedddccdedcddccddddddddddddeeede'
            'eddcddddddddddddddddddddddddddddeddddddddddddddddddddddddccc'
            'dddddddddddddddddddddedddddddddddddddddddddddddddddddddddddd'
            'dddddddcccdcdddddddddddddddddddddddddddddddddddddddddddddddd'
            'd')

        self.sax_str_2 = (
            'dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd'
            'dddddddddddddddddddddddddddddddddddddddfgacaaggaadggaabcgadb'
            'feaffdbebfebbffeecbcfebedgbddedccegdbbbffceccddeecfacfgebggc'
            'aggaaeggaagfacedeageagfgaegbaefgeeaaggbaaagfcbfecffeacefcbgb'
            'ddbeadgdddeedebddbddaeedfbefgdccacccegfcdcdfdeeffdcbaadegeec'
            'accdffecdeedeeccbbcceeeddddedcdeddcceecdeddedcdeedcbeddddcdd'
            'dddeecdeecdddcbeeddddddeedccdeddedddddddddcccdddeddeeddddcbc'
            'dedcddddccdddeddddeedddedddeedddddcdccdeedddedddddcccddddddd'
            'ddddcdddedeedddcdeedccdddddeedddddddddddddddddddddcddddddddd'
            'ddddddddddddddddddddccdddddddddddcdddddddddddddeddddddeeeddd'
            'd')
    ...
    def test_sax_detect(self):
        ...
        self.assertTrue(10000 <= duration_ms <= 15000,
                        "Event was between 8 and 15 seconds, got {}"
                        .format(duration_ms))
        ...
        self.assertTrue(10000 <= duration_ms <= 20000,
                        "Event was between 10 and 20 seconds, got {}"
                        .format(duration_ms))
        self.assertAlmostEqual(t[0][0] / 1000, 5, 1,
                               "Event was approximately 5000ms from the start,"
                               " got {}".format(t[0][0]))
    ...
    def test_full_sax_detector_class_1(self):
        ...
        self.assertTrue((10.5 <= s / 1000 <= 11),
                        "Event start was 10.5-11 seconds from start, got {}"
                        .format(s / 1000))
        self.assertTrue((20.0 <= e / 1000 <= 30.0),
                        "Event end was 20 to 30 seconds from start, got {}"
                        .format(e / 1000))
    ...
    def test_full_sax_detector_class_2(self):
        ...
        self.assertTrue((11.5 <= s / 1000 <= 12.5),
                        "Event start was 11.5 to 12.5 seconds from start, "
                        "got {}".format(s / 1000))
        self.assertTrue((25.0 <= e / 1000 <= 35.0),
                        "Event end was 20 to 30 seconds from start"
                        ", got {}".format(e / 1000))
    ...
    def test_full_stalta_detector_class_1(self):
        ...
        self.assertTrue((10.5 <= s / 1000 <= 11),
                        "Event start was 10.5 to 11 seconds from start, "
                        "got {}".format(s / 1000))
        self.assertTrue((20.0 <= e / 1000 <= 30.0),
                        "Event end was 25 to 35 seconds from start, "
                        "got {}".format(e / 1000))
