...
\end{figure}
	...
	As when looking at the amplitudes in \cref{sec:sampledata}, there is no obvious visual correlation between the stations for the same events